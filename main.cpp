...
void print_help()   {
    std::cout
        ...
        << "  -a, --algorithm <алгоритм>        elgamal | vigenere\n"
...
int main(int argc, char* argv[])    {
    ...
    if (algorithm != "elgamal" && algorithm != "vigenere")  {
    ...
    #ifdef _WIN32
        library_path = "algorithms/elgamal/elgamal.dll";
    #elif __APPLE__
        library_path = "algorithms/elgamal/libelgamal.dylib";
    #else
        library_path = "algorithms/elgamal/libelgamal.so";
    #endif
    }
    else if (algorithm == "vigenere")   {
    #ifdef _WIN32
        library_path = "algorithms/vigenere/vigenere.dll";
    #elif __APPLE__
        library_path = "algorithms/vigenere/libvigenere.dylib";
    #else
        library_path = "algorithms/vigenere/libvigenere.so";
    #endif
    }
